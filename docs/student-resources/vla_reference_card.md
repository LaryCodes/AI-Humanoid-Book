...
This card provides quick overview of Vision-Language-Action (VLA) pipeline and key components for humanoid robotics.
...
-   **Function**: Interprets text commands, robot state, and available skills generating sequence of robot actions.
...
-   **ROS 2 Environment**: Always source ROS 2 workspace before running nodes.
