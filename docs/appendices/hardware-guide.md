...
This section provides recommendations for hardware components necessary for following tutorials and building projects in this course.

## Minimum Requirements

To ensure smooth learning experience, your development machine should meet these minimum specifications:
...
For optimal performance, especially for modules involving NVIDIA Isaac Sim and Isaac ROS, NVIDIA GPU is highly recommended.
...
For advanced modules and capstone project, specific robot platforms or components might be recommended:

### Mobile Robots
-   **TurtleBot 4**: Popular open-source mobile robot platform with ROS 2 support, suitable for navigation and basic manipulation.
-   **Husky A200 / Jackal (Clearpath Robotics)**: Robust outdoor-ready mobile robot platforms for research and development.

### Manipulator Arms
-   **UR5e / UR10e (Universal Robots)**: Collaborative robot arms widely used in industry and research.
-   **Franka Emika Panda**: Highly precise and sensitive collaborative robot arm.

### Humanoid Robots (Simulation Focus)
-   **NVIDIA Digit (Agility Robotics)**: Bipedal humanoid robot. This course primarily focuses on simulating such robots in Isaac Sim.
-   **Unitree Go1 / Go2**: Quadruped robots offering dynamic locomotion.

*(These are general recommendations. The course focuses on simulation, so physical hardware is optional for most chapters.)*

## Cloud Alternatives

If you lack access to recommended hardware, cloud-based development environments can be utilized.

*(Refer to [Cloud Setup Guide](./cloud-setup.md) for detailed instructions on setting up cloud instances with GPU support.)*
